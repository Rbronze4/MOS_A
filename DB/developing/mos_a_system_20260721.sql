...
(17, 16, 0, '2026-07-21 14:37:55', '2026-07-21 14:37:55');
...
CREATE TABLE `cart_details` (
  ...
  `option_signature` varchar(255) NOT NULL DEFAULT '' COMMENT '驕ｸ謚槭が繝励す繝ｧ繝ｳID縺ｮ豁｣隕丞喧貂医∩讒区?',
...
INSERT INTO `cart_details` (`cart_detail_id`, `cart_id`, `product_id`, `option_signature`, `quantity`, `added_at`, `updated_at`) VALUES
(22, 12, 621, '', 1, '2026-07-07 06:08:00', '2026-07-21 14:33:35');
...
(11, 16, 'customer-16-3fc4a787154abe5f08601b3afa4d95ba', '2026-07-21 14:39:08', '2026-07-21 14:39:08', '2026-07-21 14:39:08');
...
(23, 11, 643, 'ももサワー', 1, 200, 0, '2026-07-21 14:39:08', 'ORDERED', 0, NULL, NULL, '2026-07-21 14:39:08', '2026-07-21 14:39:08'),
(24, 11, 643, 'ももサワー', 1, 200, 0, '2026-07-21 14:39:08', 'ORDERED', 0, NULL, NULL, '2026-07-21 14:39:08', '2026-07-21 14:39:08'),
(25, 11, 625, 'ハイボール', 1, 450, 0, '2026-07-21 14:39:08', 'ORDERED', 0, NULL, NULL, '2026-07-21 14:39:08', '2026-07-21 14:39:08');
...
--
-- テーブルのデータのダンプ `order_detail_options`
--

INSERT INTO `order_detail_options` (`order_detail_id`, `option_id`, `ordered_option_name`, `ordered_additional_price`, `created_at`) VALUES
(23, 1, '氷あり', 0, '2026-07-21 14:39:08'),
(24, 2, '氷無し', 0, '2026-07-21 14:39:08');
...
(8, 'サービス', '2026-07-21 14:40:21', '2026-07-21 14:40:21');
...
(16, 1000004, 'MH', '5', 'ACTIVE', '2026-07-21 14:37:55', '2026-07-21 17:37:55', NULL, '2026-07-21 14:37:55', '2026-07-21 14:37:55');
...
ALTER TABLE `cart_details`
  ...
  ADD UNIQUE KEY `uq_cart_details_cart_product_options` (`cart_id`,`product_id`,`option_signature`),
...
--
ALTER TABLE `carts`
  MODIFY `cart_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'かごID', AUTO_INCREMENT=18;

--
-- テーブルの AUTO_INCREMENT `cart_details`
--
ALTER TABLE `cart_details`
  MODIFY `cart_detail_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'かご明細ID', AUTO_INCREMENT=32;
...
--
ALTER TABLE `orders`
  MODIFY `order_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '注文ID', AUTO_INCREMENT=12;

--
-- テーブルの AUTO_INCREMENT `order_details`
--
ALTER TABLE `order_details`
  MODIFY `order_detail_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '注文詳細ID', AUTO_INCREMENT=26;
...
--
ALTER TABLE `sessions`
  MODIFY `session_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'セッションID', AUTO_INCREMENT=17;
