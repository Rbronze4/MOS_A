    ...
    private function plans(): array
    {
        ...
        $menus = [
            ...
            [/** 商品の追加　画像は後から付きます　付いてなかったら教えてください */
                ...
                'name' => 'ももタレ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/momotare.png',
            ],
            [
                'id' => 13,
                'category' => '串',
                'name' => 'つくねチーズ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/tukuneti-zu.png',
            ],
            [
                'id' => 14,
                'category' => '串',
            ...
            [
                ...
                'name' => 'チーズもち',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/ti-zumoti.png',
            ],
            [
                'id' => 16,
                'category' => '一品',
            ...
            [
                ...
                'name' => 'やみつきキャベツ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/yamitukikyabetu.png',
            ],
            [
                'id' => 18,
                'category' => '一品',
                'name' => '鉄板やまいも',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/teppanyamaimo.png',
            ],
            [
                'id' => 19,
                'category' => '一品',
                'name' => '明太ポテサラ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/mentaipotesara.png',
            ],
            [
                'id' => 20,
                'category' => '一品',
                'name' => 'チャンジャ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/tyanja.png',
            ],
            [
                'id' => 21,
                'category' => '揚げ物',
                'name' => 'ポテトフライ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/potetohurai.png',
            ],
            [
                'id' => 22,
                'category' => '揚げ物',
                'name' => '揚げ餃子',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/agegyouza.png',
            ],
            [
                'id' => 23,
                'category' => '揚げ物',
                'name' => 'チキン南蛮',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/tikinnanban.png',
            ],
            [
                'id' => 24,
                'category' => '揚げ物',
                'name' => '手羽先の唐揚げ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/tebasakinokaraage.png',
            ],
            [
                'id' => 25,
                'category' => '揚げ物',
                'name' => '軟骨の唐揚げ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/nankotunokaraage.png',
            ],
            [
                'id' => 26,
                'category' => 'ご飯もの',
                'name' => '焼き鳥丼',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/yakitoridon.png',
            ],
            [
                'id' => 27,
                'category' => 'ご飯もの',
                'name' => '鳥雑炊',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/torizosui.png',
            ],
            [
                'id' => 28,
                'category' => 'ご飯もの',
                'name' => 'ソースかつ丼',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/so-sukatudon.png',
            ],
            [
                'id' => 29,
                'category' => 'ご飯もの',
                'name' => 'ご飯セット',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/gohansetto.png',
            ],
            [
                'id' => 30,
                'category' => 'ご飯もの',
                'name' => '釜めし',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/kamamesi.png',
            ],
            [
                'id' => 31,
                'category' => 'ご飯もの',
                'name' => 'からマヨ丼',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/karamayodon.png',
            ],
            [
                'id' => 32,
                'category' => '期間限定',
            ...
            [
                ...
                'name' => 'カニ雑炊',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/kanizosui.png',
            ],
            [
                'id' => 34,
                'category' => '期間限定',
                'name' => '牡蠣のバター炒め',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/kakinobata-itame.png',
            ],
            [
                'id' => 35,
                'category' => '店舗限定',
                'name' => 'アヒージョ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/ahi-jo.png',
            ],
            [
                'id' => 36,
                'category' => '店舗限定',
                'name' => 'ベーコンステーキ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/be-konsute-ki.png',
            ],
            [
                'id' => 37,
                'category' => '店舗限定',
                'name' => 'ひとくちチョコケーキ',
                'price' => 100,
                'image_path' => '/MOS_A/public/assets/images/menu/hitokutityokoke-ki.png',
            ],
        ];
