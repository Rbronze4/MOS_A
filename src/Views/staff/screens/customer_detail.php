            ...
            <div class="customer-detail-card">
                <table class="data-table customer-detail-table">
                    <tbody>
                        <tr>
                            <th>顧客番号</th>
                            <td><?= h((string)$customerDetail['customer_id']) ?></td>
                        </tr>
                        <tr>
                            <th>人数</th>
                ...
                <div class="customer-detail-actions">
                    <button
                        class="white-button"
                        type="button"
                        onclick="location.href='/MOS_A/public/staff/customer/orders?customer_id=<?= h((string)$customerDetail['customer_id']) ?>'"
                    >注文詳細</button>
                </div>
            </div>
        <?php endif; ?>
