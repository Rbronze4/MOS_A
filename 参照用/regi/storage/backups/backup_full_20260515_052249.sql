-- Backup created at 2026-05-15 05:22:49
...
INSERT INTO `accounts` (`account_id`, `login_id`, `password_hash`, `account_name`, `role_type`, `store_id`, `email`, `is_active`, `last_login_at`, `created_at`, `updated_at`) VALUES ('3', 'master', '$2y$10$ZvPXtznJpAb9Yy0vzUqJk.sOTbaWxOsODasPeEkDJ/jo3Nn/l4Gsu', 'マスター管理者', 'MASTER', NULL, 'master@example.com', '1', '2026-05-15 04:58:00', '2026-04-14 00:13:05', '2026-05-15 05:22:35');
...
INSERT INTO `stores` (`store_id`, `store_name`, `store_address`, `store_phone`, `is_active`, `created_at`, `updated_at`) VALUES ('AA', '緑橋本店', '大阪府大阪市東成区東中本1-2-10', '06-6971-0001', '1', '2026-04-25 23:11:26', '2026-05-15 05:22:39');
