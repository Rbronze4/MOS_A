-- Backup created at 2026-04-25 16:43:02
...
INSERT INTO `accounts` (`account_id`, `login_id`, `password_hash`, `account_name`, `role_type`, `store_id`, `email`, `is_active`, `last_login_at`, `created_at`, `updated_at`) VALUES ('1', 'staff0001', '$2y$10$ZvPXtznJpAb9Yy0vzUqJk.sOTbaWxOsODasPeEkDJ/jo3Nn/l4Gsu', '緑橋店01', 'STAFF', 'AA', NULL, '1', '2026-04-25 23:27:57', '2026-04-03 22:37:51', '2026-04-25 23:27:57');
...
INSERT INTO `accounts` (`account_id`, `login_id`, `password_hash`, `account_name`, `role_type`, `store_id`, `email`, `is_active`, `last_login_at`, `created_at`, `updated_at`) VALUES ('3', 'master', '$2y$10$ZvPXtznJpAb9Yy0vzUqJk.sOTbaWxOsODasPeEkDJ/jo3Nn/l4Gsu', 'マスター管理者', 'MASTER', NULL, 'master@example.com', '1', '2026-04-25 23:28:22', '2026-04-14 00:13:05', '2026-04-25 23:28:22');
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='???v?w?b?_';
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='???v????';
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='?x????????';
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='???????v';
...
INSERT INTO `stores` (`store_id`, `store_name`, `store_address`, `store_phone`, `is_active`, `created_at`, `updated_at`) VALUES ('AA', '緑橋本店\r\n', '大阪府大阪市東成区東中本1-2-10\r\n', '06-6971-0001', '1', '2026-04-25 23:11:26', '2026-04-25 23:36:45');
